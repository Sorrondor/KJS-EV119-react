...
const VisitHistory = () => {
  ...
  useEffect(() => {
    const getVisitedList = async () => {
      try {
        const response = await fetch(`${API_BASE_URL}/my-page/visited`, {
          method: "GET",
          headers: {
        ...
        console.error("방문 이력 조회에 실패했습니다:", error);
      }
    };
    getVisitedList();
  }, []);
  ...
  const handleAdd = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/my-page/visited/add`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
      ...
      console.error("방문 이력 추가 중 오류:", error);
  ...
  const handleDelete = async (visit) => {
    if (window.confirm("이 방문 이력을 삭제하시겠습니까?")) {
      try {
        const response = await fetch(`${API_BASE_URL}/my-page/visited/delete`, {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
        ...
        console.error("방문 이력 삭제 중 오류:", error);
            ...
            <S.HistoryCard key={index}>
              ...
              {visit.visitedDiagnosis && (
                <S.InfoRow>
                  ...
                  <S.InfoValue $highlight>{visit.visitedDiagnosis}</S.InfoValue>
                </S.InfoRow>
              )}
